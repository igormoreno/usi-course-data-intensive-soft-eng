...
public abstract class SupplierService {
	...
	static {
		defaultLoadingParameters.put(ROLE_NAME.SUPPLIES_SUPPLIERREF, loading.Loading.LAZY);
	}
	...
	public Supplier getSupplierById(Integer supplierID){
		Condition cond;
		cond = Condition.simple(SupplierAttribute.supplierID, conditions.Operator.EQUALS, supplierID);
	...
	public Dataset<Supplier> getSupplierListBySupplierID(Integer supplierID) {
		return getSupplierList(conditions.Condition.simple(conditions.SupplierAttribute.supplierID, conditions.Operator.EQUALS, supplierID));
	}
	...
	private static Dataset<Supplier> fullOuterJoinsSupplier(List<Dataset<Supplier>> datasetsPOJO, String joinMode) {
		...
		Dataset<Supplier> d = datasetsPOJO.get(0);
			...
			d = res.map((MapFunction<Row, Supplier>) r -> {
					...
					supplier_res.setSupplierID(firstNotNull_supplierID);
					...
					for (int i = 1; i < datasetsPOJO.size(); i++) {
						...
						if (firstNotNull_address != null && address2 != null && !firstNotNull_address.equals(address2)) {
							supplier_res.addLogEvent("Data consistency problem for [Supplier - id :"+supplier_res.getSupplierID()+"]: different values found for attribute 'Supplier.address': " + firstNotNull_address + " and " + address2 + "." );
							logger.warn("Data consistency problem for [Supplier - id :"+supplier_res.getSupplierID()+"]: different values found for attribute 'Supplier.address': " + firstNotNull_address + " and " + address2 + "." );
						}
					...
					for (int i = 1; i < datasetsPOJO.size(); i++) {
						...
						if (firstNotNull_city != null && city2 != null && !firstNotNull_city.equals(city2)) {
							supplier_res.addLogEvent("Data consistency problem for [Supplier - id :"+supplier_res.getSupplierID()+"]: different values found for attribute 'Supplier.city': " + firstNotNull_city + " and " + city2 + "." );
							logger.warn("Data consistency problem for [Supplier - id :"+supplier_res.getSupplierID()+"]: different values found for attribute 'Supplier.city': " + firstNotNull_city + " and " + city2 + "." );
						}
					...
					for (int i = 1; i < datasetsPOJO.size(); i++) {
						...
						if (firstNotNull_companyName != null && companyName2 != null && !firstNotNull_companyName.equals(companyName2)) {
							supplier_res.addLogEvent("Data consistency problem for [Supplier - id :"+supplier_res.getSupplierID()+"]: different values found for attribute 'Supplier.companyName': " + firstNotNull_companyName + " and " + companyName2 + "." );
							logger.warn("Data consistency problem for [Supplier - id :"+supplier_res.getSupplierID()+"]: different values found for attribute 'Supplier.companyName': " + firstNotNull_companyName + " and " + companyName2 + "." );
						}
					...
					for (int i = 1; i < datasetsPOJO.size(); i++) {
						...
						if (firstNotNull_contactName != null && contactName2 != null && !firstNotNull_contactName.equals(contactName2)) {
							supplier_res.addLogEvent("Data consistency problem for [Supplier - id :"+supplier_res.getSupplierID()+"]: different values found for attribute 'Supplier.contactName': " + firstNotNull_contactName + " and " + contactName2 + "." );
							logger.warn("Data consistency problem for [Supplier - id :"+supplier_res.getSupplierID()+"]: different values found for attribute 'Supplier.contactName': " + firstNotNull_contactName + " and " + contactName2 + "." );
						}
					...
					for (int i = 1; i < datasetsPOJO.size(); i++) {
						...
						if (firstNotNull_contactTitle != null && contactTitle2 != null && !firstNotNull_contactTitle.equals(contactTitle2)) {
							supplier_res.addLogEvent("Data consistency problem for [Supplier - id :"+supplier_res.getSupplierID()+"]: different values found for attribute 'Supplier.contactTitle': " + firstNotNull_contactTitle + " and " + contactTitle2 + "." );
							logger.warn("Data consistency problem for [Supplier - id :"+supplier_res.getSupplierID()+"]: different values found for attribute 'Supplier.contactTitle': " + firstNotNull_contactTitle + " and " + contactTitle2 + "." );
						}
					...
					for (int i = 1; i < datasetsPOJO.size(); i++) {
						...
						if (firstNotNull_country != null && country2 != null && !firstNotNull_country.equals(country2)) {
							supplier_res.addLogEvent("Data consistency problem for [Supplier - id :"+supplier_res.getSupplierID()+"]: different values found for attribute 'Supplier.country': " + firstNotNull_country + " and " + country2 + "." );
							logger.warn("Data consistency problem for [Supplier - id :"+supplier_res.getSupplierID()+"]: different values found for attribute 'Supplier.country': " + firstNotNull_country + " and " + country2 + "." );
						}
					...
					for (int i = 1; i < datasetsPOJO.size(); i++) {
						...
						if (firstNotNull_fax != null && fax2 != null && !firstNotNull_fax.equals(fax2)) {
							supplier_res.addLogEvent("Data consistency problem for [Supplier - id :"+supplier_res.getSupplierID()+"]: different values found for attribute 'Supplier.fax': " + firstNotNull_fax + " and " + fax2 + "." );
							logger.warn("Data consistency problem for [Supplier - id :"+supplier_res.getSupplierID()+"]: different values found for attribute 'Supplier.fax': " + firstNotNull_fax + " and " + fax2 + "." );
						}
					...
					for (int i = 1; i < datasetsPOJO.size(); i++) {
						...
						if (firstNotNull_homePage != null && homePage2 != null && !firstNotNull_homePage.equals(homePage2)) {
							supplier_res.addLogEvent("Data consistency problem for [Supplier - id :"+supplier_res.getSupplierID()+"]: different values found for attribute 'Supplier.homePage': " + firstNotNull_homePage + " and " + homePage2 + "." );
							logger.warn("Data consistency problem for [Supplier - id :"+supplier_res.getSupplierID()+"]: different values found for attribute 'Supplier.homePage': " + firstNotNull_homePage + " and " + homePage2 + "." );
						}
					...
					for (int i = 1; i < datasetsPOJO.size(); i++) {
						...
						if (firstNotNull_phone != null && phone2 != null && !firstNotNull_phone.equals(phone2)) {
							supplier_res.addLogEvent("Data consistency problem for [Supplier - id :"+supplier_res.getSupplierID()+"]: different values found for attribute 'Supplier.phone': " + firstNotNull_phone + " and " + phone2 + "." );
							logger.warn("Data consistency problem for [Supplier - id :"+supplier_res.getSupplierID()+"]: different values found for attribute 'Supplier.phone': " + firstNotNull_phone + " and " + phone2 + "." );
						}
					...
					for (int i = 1; i < datasetsPOJO.size(); i++) {
						...
						if (firstNotNull_postalCode != null && postalCode2 != null && !firstNotNull_postalCode.equals(postalCode2)) {
							supplier_res.addLogEvent("Data consistency problem for [Supplier - id :"+supplier_res.getSupplierID()+"]: different values found for attribute 'Supplier.postalCode': " + firstNotNull_postalCode + " and " + postalCode2 + "." );
							logger.warn("Data consistency problem for [Supplier - id :"+supplier_res.getSupplierID()+"]: different values found for attribute 'Supplier.postalCode': " + firstNotNull_postalCode + " and " + postalCode2 + "." );
						}
					...
					for (int i = 1; i < datasetsPOJO.size(); i++) {
						...
						if (firstNotNull_region != null && region2 != null && !firstNotNull_region.equals(region2)) {
							supplier_res.addLogEvent("Data consistency problem for [Supplier - id :"+supplier_res.getSupplierID()+"]: different values found for attribute 'Supplier.region': " + firstNotNull_region + " and " + region2 + "." );
							logger.warn("Data consistency problem for [Supplier - id :"+supplier_res.getSupplierID()+"]: different values found for attribute 'Supplier.region': " + firstNotNull_region + " and " + region2 + "." );
						}
	...
	public Supplier getSupplier(Supplier.supplies role, Product product) {
		if(role != null) {
			if(role.equals(Supplier.supplies.supplierRef))
				return getSupplierRefInSuppliesBySuppliedProduct(product);
		}
		return null;
	}
	
	public Dataset<Supplier> getSupplierList(Supplier.supplies role, Condition<ProductAttribute> condition) {
		if(role != null) {
			if(role.equals(Supplier.supplies.supplierRef))
				return getSupplierRefListInSuppliesBySuppliedProductCondition(condition);
		}
		return null;
	}
	
	public Dataset<Supplier> getSupplierList(Supplier.supplies role, Condition<ProductAttribute> condition1, Condition<SupplierAttribute> condition2) {
		if(role != null) {
			if(role.equals(Supplier.supplies.supplierRef))
				return getSupplierRefListInSupplies(condition1, condition2);
		}
		return null;
	}
	...
	public abstract Dataset<Supplier> getSupplierRefListInSupplies(conditions.Condition<conditions.ProductAttribute> suppliedProduct_condition,conditions.Condition<conditions.SupplierAttribute> supplierRef_condition);
	
	public Dataset<Supplier> getSupplierRefListInSuppliesBySuppliedProductCondition(conditions.Condition<conditions.ProductAttribute> suppliedProduct_condition){
		return getSupplierRefListInSupplies(suppliedProduct_condition, null);
	}
	
	public Supplier getSupplierRefInSuppliesBySuppliedProduct(pojo.Product suppliedProduct){
		if(suppliedProduct == null)
			return null;
	
		Condition c;
		c=Condition.simple(ProductAttribute.productID,Operator.EQUALS, suppliedProduct.getProductID());
		Dataset<Supplier> res = getSupplierRefListInSuppliesBySuppliedProductCondition(c);
		return !res.isEmpty()?res.first():null;
	}
	
	public Dataset<Supplier> getSupplierRefListInSuppliesBySupplierRefCondition(conditions.Condition<conditions.SupplierAttribute> supplierRef_condition){
		return getSupplierRefListInSupplies(null, supplierRef_condition);
	}
	...
	public abstract void updateSupplierRefListInSupplies(
	...
	public void updateSupplierRefListInSuppliesBySuppliedProductCondition(
		conditions.Condition<conditions.ProductAttribute> suppliedProduct_condition,
		conditions.SetClause<conditions.SupplierAttribute> set
	){
		updateSupplierRefListInSupplies(suppliedProduct_condition, null, set);
	}
	
	public void updateSupplierRefInSuppliesBySuppliedProduct(
		pojo.Product suppliedProduct,
		conditions.SetClause<conditions.SupplierAttribute> set 
	){
	...
	public void updateSupplierRefListInSuppliesBySupplierRefCondition(
		conditions.Condition<conditions.SupplierAttribute> supplierRef_condition,
		conditions.SetClause<conditions.SupplierAttribute> set
	){
		updateSupplierRefListInSupplies(null, supplierRef_condition, set);
	}
	...
	public abstract void deleteSupplierRefListInSupplies(	
		conditions.Condition<conditions.ProductAttribute> suppliedProduct_condition,	
		conditions.Condition<conditions.SupplierAttribute> supplierRef_condition);
	
	public void deleteSupplierRefListInSuppliesBySuppliedProductCondition(
		conditions.Condition<conditions.ProductAttribute> suppliedProduct_condition
	){
		deleteSupplierRefListInSupplies(suppliedProduct_condition, null);
	}
	
	public void deleteSupplierRefInSuppliesBySuppliedProduct(
		pojo.Product suppliedProduct 
	){
		//TODO get id in condition
		return;	
	...
	public void deleteSupplierRefListInSuppliesBySupplierRefCondition(
		conditions.Condition<conditions.SupplierAttribute> supplierRef_condition
	){
		deleteSupplierRefListInSupplies(null, supplierRef_condition);
	}
