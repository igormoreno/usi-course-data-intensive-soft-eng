...
public abstract class SuppliesService {
	...
	public abstract Dataset<SupplierTDO> getSupplierTDOListSupplierRefInProdSuppliedInSuppliersFromMyMongoDB(Condition<SupplierAttribute> condition, MutableBoolean refilterFlag);
	
	// Right side 'ProductID' of reference [prodSupplied ]
	public abstract Dataset<ProductTDO> getProductTDOListSuppliedProductInProdSuppliedInSuppliersFromMyMongoDB(Condition<ProductAttribute> condition, MutableBoolean refilterFlag);
