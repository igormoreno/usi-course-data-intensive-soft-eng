...
public abstract class ProductService {
	...
	public Dataset<Product> getProductList(conditions.Condition<conditions.ProductAttribute> condition){
		...
		d = getProductListInOrdersFromMyMongoDB(condition, refilterFlag);
		if(d != null)
			datasets.add(d);
		d = getProductListInProductFromMyRedis(condition, refilterFlag);
		if(d != null)
			datasets.add(d);
	...
	public abstract Dataset<Product> getProductListInOrdersFromMyMongoDB(conditions.Condition<conditions.ProductAttribute> condition, MutableBoolean refilterFlag);
	
	
	
	
	
	public abstract Dataset<Product> getProductListInProductFromMyRedis(conditions.Condition<conditions.ProductAttribute> condition, MutableBoolean refilterFlag);
	...
	public abstract boolean insertProductInProductFromMyRedis(Product product); 
	public abstract boolean insertProductInSuppliersFromMyMongoDB(Product product,
		Supplier	supplierRefSupplies);
