...
public abstract class Composed_ofService {
	...
	public abstract Dataset<OrderTDO> getOrderTDOListOrderRefInOrderRefInOrdersFromMyMongoDB(Condition<OrderAttribute> condition, MutableBoolean refilterFlag);
	...
	public abstract Dataset<Composed_ofTDO> getComposed_ofTDOListInProductsInfoAndOrder_DetailsFromreldata(Condition<ProductAttribute> productRef_cond, Condition<Composed_ofAttribute> composed_of_cond, MutableBoolean refilterFlag, MutableBoolean composed_of_refilter);
